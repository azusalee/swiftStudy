...
// 1.使用数组定义一组数据
let infoArray : [NSObject] = ["why" as NSObject, 18 as NSObject, 1.88 as NSObject]
let nameArray = infoArray[0]
// let nameCount = nameArray.characters

// 2.使用字典定义一组数据
let infoDict : [String : NSObject] = ["name" : "why" as NSObject, "age" : 18 as NSObject, "height" : 1.88 as NSObject]
